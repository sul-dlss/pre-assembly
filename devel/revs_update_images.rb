...
# the manifest are 'sourceid' and 'filename'
...
remediate_logic_file='/thumpers/dpgthumper-staging/Revs/revs_update_images_remediation.rb' # the revs update mods remeditation class
...
#  pid='druid:qh202yd6550'  
   ...
   if done 
     ...
     data={:new_image=>File.join(source_path,row.filename),:environment=>ENV['ROBOT_ENVIRONMENT']}
