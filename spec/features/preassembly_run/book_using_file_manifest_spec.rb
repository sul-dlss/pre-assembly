...
RSpec.describe 'Pre-assemble Book Using File Manifest' do
  ...
  let(:dsc_object_version) { instance_double(Dor::Services::Client::ObjectVersion, status:, current: 1) }
  let(:status) { instance_double(Dor::Services::Client::ObjectVersion::VersionStatus, openable?: true, open?: true, version: 1, accessioning?: false) }
