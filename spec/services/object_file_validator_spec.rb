...
RSpec.describe ObjectFileValidator do
  ...
  describe '#validate' do
    ...
    context 'folders are not empty' do
      let(:obj_file) { instance_double(Assembly::ObjectFile, path: '', relative_path: 'random/path', filesize: 324, mimetype: '') }
    ...
    context 'missing_media_container_name_or_manifest' do
      ...
      let(:obj_file) { instance_double(Assembly::ObjectFile, path: '', relative_path: '', filesize: 324, mimetype: '') }
