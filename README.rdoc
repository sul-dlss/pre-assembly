...
in steps 1 and 2.  Note that the CSV file will be updated, so it should in be a location where the script will have read/write access to it
(i.e. not on a thumper drive). 
