...
2.4.5:: Add in automatic retrying of exceptions in content metadata generation and file validation to deal with random out of memory exceptions in assembly-objectfile gem when computing mimetypes
